...
const BASE_PARAMS =
  "&include_adult=false&include_video=false&language=en-US&sort_by=popularity.desc&vote_count.gte=200.0&vote_average.gte=7.0&with_original_language=en";

const generateRandomPage = () => Math.floor(Math.random() * 100);
